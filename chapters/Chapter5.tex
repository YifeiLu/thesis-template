...
Each reference entry has a unique BibTeX key within your Citavi project, which can be directly used in \LaTeX~environment with the command {\color{blue}{\verb|\cite|}}. For example, type {\color{blue}{\verb|\cite{Burger.20180508}|}} , the corresponding reference will be referred in the text \cite{Burger.20180508}.
